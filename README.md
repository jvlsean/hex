...
**Trace.EXE** doesnt uses copyrighted content, all contents are created by me!

# Coding Language
**Trace.EXE** is using Lua coding language with Love2D framework. To play, make sure to go to Releases and find your OS. Currently supporting **Linux** and **Windows**.
